...
namespace WorldEdit_2_0.MainEditor
{
    public class WorldUpdater
    {
        ...
        public void RenderSingleTile(int tileID, Material drawMaterial, List<LayerSubMesh> subMeshes)
        {
            ...
            {
                subMesh.verts.Add(verts[i] + verts[i].normalized * 0.013f);
        ...
        public void RenderSingleTile(List<int> tileIDs, Material drawMaterial, List<LayerSubMesh> subMeshes)
        {
            ...
            {
                RenderSingleTile(tileID, drawMaterial, subMeshes);
            }
        }
        ...
        public void RenderSingleHill(List<int> tileIDs, List<LayerSubMesh> subMeshes)
        {
            foreach (var tileID in tileIDs)
            {
                RenderSingleHill(tileID, subMeshes);
            }
        }
        ...
        private void FinalizeMesh(MeshParts tags, LayerSubMesh subMesh)
        {
        ...
        private void FinalizeMesh(MeshParts tags, List<LayerSubMesh> subMeshes)
        {
            for (int i = 0; i < subMeshes.Count; i++)
            {
